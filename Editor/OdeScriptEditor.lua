local Lexer = loadstring(game:HttpGet("https://raw.githubusercontent.com/VallionXD/Lunar-Executor/main/Editor/Modules/Lexer.lua"))()
local LuaTable = loadstring(game:HttpGet("https://raw.githubusercontent.com/VallionXD/Lunar-Executor/main/Editor/Modules/LuaTable.lua"))()
local SignalModule = loadstring(game:HttpGet("https://raw.githubusercontent.com/VallionXD/Lunar-Executor/main/Editor/Modules/SignalModule.lua"))()
local GetTextBoxScrolling = loadstring(game:HttpGet("https://raw.githubusercontent.com/VallionXD/Lunar-Executor/main/Editor/Modules/GetTextboxScrolling.lua"))()
local InitGui = loadstring(game:HttpGet("https://raw.githubusercontent.com/VallionXD/Lunar-Executor/main/Editor/Modules/InitGui.lua"))()
...
local OdeDefaultTheme = {
	...
	sidebar = Color3.fromRGB(27, 27, 30),
